...
export const API_PORTAL_PATH = import.meta.env.VITE_SERVER_ADDRESS + '/portal'
export const API_PORTAL_IMAGE_PATH = import.meta.env.VITE_SERVER_ADDRESS + '/image'
export const ARTICLE_SUMMARY_LENGTH = 100
